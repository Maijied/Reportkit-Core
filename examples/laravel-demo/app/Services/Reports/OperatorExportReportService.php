...
use App\Repositories\Reports\OperatorExportReportRepository;
use ReportKit\Core\Date\DateRangeChunker;
use ReportKit\Core\Contracts\RowSource;

class OperatorExportReportService implements RowSource
{
    private $repository;
    private $chunker;
    ...
    {
        $this->repository = $repository instanceof OperatorExportReportRepository
            ? $repository
            : new OperatorExportReportRepository();
